...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0b1412] text-white selection:bg-[#0f4d42] selection:text-white overflow-x-hidden">
      <Navbar />
      ...
      <main>
        ...
        {/* TRAINING & EDUCATION */}
        <section id="training" className="py-32 px-6 bg-[#111d1a] border-y border-white/5">
             ...
             <div className="grid grid-cols-1 lg:grid-cols-2 gap-32">
                ...
                <div className="grid grid-cols-1 gap-px bg-white/10 border border-white/5">
                   {[
                     ...
                     <div key={i} className="reveal opacity-0 translate-y-12 p-10 bg-[#0b1412] hover:bg-[#111d1a] transition-all duration-500">
